...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post picks_url, params: { pick: { description: @pick.description, group_id: @pick.group_id, location: @pick.location, picture: @pick.picture } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { description: @pick.description, group_id: @pick.group_id, location: @pick.location, picture: @pick.picture } }
